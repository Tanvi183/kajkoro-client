...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    setError(null);
    if (email === "employer@gmail.com" && password === "12345678") {
      router.push("/employer/dashboard");
    } else if (email === "worker@gmail.com" && password === "12345678") {
      router.push("/worker/dashboard");
    } else if (email === "admin@gmail.com" && password === "12345678") {
      router.push("/admin/dashboard");
    } else {
      setError("Invalid credentials. Use admin@gmail.com, employer@gmail.com or worker@gmail.com / 12345678 to test.");
    }
  };
    ...
    <div className="w-full max-w-md pt-12">
      ...
      <Card className="w-full">
        <CardContent className="pt-8">
          {error && (
            <div className="mb-6 rounded-md bg-red-50 p-4 border border-red-200 dark:bg-red-950/30 dark:border-red-900/50">
              <div className="flex">
