        ...
        <div className="flex flex-col gap-3 w-full md:w-80">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full rounded-md border-0 py-2.5 pl-10 pr-3 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6 dark:bg-slate-900 dark:text-white dark:ring-slate-700"
            />
          </div>
          ...
          <div className="relative">
            ...
            <select
              className="block w-full appearance-none rounded-md border-0 py-2.5 pl-10 pr-10 text-slate-900 font-medium shadow-sm ring-1 ring-inset ring-emerald-200 bg-emerald-50 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6 dark:bg-slate-900 dark:text-white dark:ring-slate-700"
            >
